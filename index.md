...
I'm Joe. I'm homeless, I have a laptop, and I'm using AI coding agents to build serious software - starting with a memory-safe Rust PDF engine.

This blog documents every day of that journey: the code, the strategy, the wins, and the failures.

[Sponsor my work](https://github.com/sponsors/nohomedirectory)
