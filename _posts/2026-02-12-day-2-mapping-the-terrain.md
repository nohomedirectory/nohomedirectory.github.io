...
There, I continued mapping out my problem space. I gathered up a bunch of context from [@doodlestein](https://x.com/doodlestein) on x.com. I settled on using the built in Grok, expert mode, with the prompt (and slight variations):

> "Hello there. I'd like you to gather for me a bunch of information from @doodlestein user here on x. I am specifically interested in the planning process, beads conversion from a plan/spec, and project structure. Here is the following I currently have in a GDoc: "ORIGINAL PARAGRAPH (not from Jeffrey):
